...
/// `[HARD_DIS_JTAG]` Set this bit to disable JTAG in the hard way. JTAG is disabled permanently
...
/// `[DIS_USB_DOWNLOAD_MODE]` Set this bit to disable UART download mode through USB
